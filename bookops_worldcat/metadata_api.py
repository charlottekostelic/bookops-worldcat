...
class MetadataSession(WorldcatSession):
    ...
    def _url_search_base_v2(self) -> str:
        return "https://americas.discovery.api.oclc.org/worldcat/search/v2"
    ...
    def _url_member_summary_holdings_v2(self) -> str:
        base_url = self._url_search_base_v2()
        return f"{base_url}/bibs-summary-holdings"

    def _url_member_general_holdings_v2(self) -> str:
        base_url = self._url_search_base_v2()
        return f"{base_url}/bibs-holdings"
    
    def _url_member_detailed_holdings_v2(self) -> str:
        base_url = self._url_search_base_v2()
        return f"{base_url}/bibs-detailed-holdings"
    ...
    def search_summary_holdings(
        ...
        heldByGroup: Optional[str] = None,
        heldBySymbol: Optional[str] = None,
        heldByInstitutionID: Optional[str] = None,
        lat: Optional[float] = None,
        lon: Optional[float] = None,
        distance: Optional[int] = None,
        unit: Optional[str] = None,
        ...
        url = self._url_member_summary_holdings_v2()
        header = {"Accept": "application/json"}
        payload = {
            "oclcNumber": oclcNumber,
            "isbn": isbn,
    ...
    def search_holdings(
        ...
        distance: Optional[int] = None,
        unit: Optional[str] = None,
        numberNearestHoldings: Optional[str] = None,
        offset: Optional[int] = None,
        limit: Optional[int] = None,
        hooks: Optional[Dict[str, Callable]] = None,
    ) -> Response:
        ...
        url = self._url_member_general_holdings_v2()
        header = {"Accept": "application/json"}
        payload = {
            "oclcNumber": oclcNumber,
            "isbn": isbn,
    ...
    def search_detailed_holdings(
        ...
        """
        Given a known item gets summary of holdings.
        Uses /bibs-detailed-holdings endpoint.
        ...
        url = self._url_member_detailed_holdings_v2()
        header = {"Accept": "application/json"}
        payload = {
            "oclcNumber": oclcNumber,
            "isbn": isbn,
